...
public class TestLoginCommand extends AbstractTestCommand {
    ...
    public void testLogin() throws Exception {
        ...
        commandInvoker.argument("password", USER_PASSWORD);

        doReturn(true).when(mockMultiRemoteCodenvy).login(CodenvyOnpremPreferences.CODENVY_ONPREM_REMOTE_NAME, USER, USER_PASSWORD);
    ...
    public void testLoginFailed() throws Exception {
        ...
        // simulate fail login
        doReturn(false).when(mockMultiRemoteCodenvy).login(CodenvyOnpremPreferences.CODENVY_ONPREM_REMOTE_NAME, USER, USER_PASSWORD);
