...
public class TestAbstractIMCommand {
    ...
    private String PREFERENCES_WITH_SAAS_SERVER_FILE               = "preferences-with-codenvy-onprem-server-remote.json";
    private String PREFERENCES_WITH_SAAS_SERVER_WITHOUT_LOGIN_FILE = "preferences-with-codenvy-onprem-remote-without-login.json";
